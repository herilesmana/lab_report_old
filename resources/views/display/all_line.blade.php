  ...
  <script>
   ...
   <script type="text/javascript">
    ...
    $.ajax({
        ...
        function get_sample_result(dept,line) {
         $.ajax({
                ...
                if(response.sample_time.substr(0,5) != localStorage.getItem('line_01_bag_jam_before'))
                {
                    if (response.jenis_variant == 'lokal')
                    {
                        if(response.nilai_pv < 2.50) {
                          $('#'+line.toLowerCase()+' .komposisi').html('0');
                        ...
                        if(response.nilai_pv >= 3.00 && response.nilai_pv <= 3.50 ) {
                          $('#'+line.toLowerCase()+' .komposisi').html('20% BB<br>80% BK');
                          $('#'+line.toLowerCase()+' .disposisi').html('OK');
                          kedip_background(''+line.toLowerCase()+'', 'mark-green');
                        }
                    ...
                    localStorage.setItem('line_01_bag_jam_before', response.sample_time.substr(0,5));
                }
              }
            },
            error: function (error) {
