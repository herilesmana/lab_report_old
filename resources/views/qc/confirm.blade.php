        ...
        <div class="modal-content">
            ...
            <form id="create_sample">
              <div class="modal-body">
                  @csrf
                  <h6>Tangki</h6>
                  <label for="BKA" class="btn btn-outline-primary"><input type="radio" name="tangki" value="BKA" id="BKA">BK A</label>
                  <label for="BKB" class="btn btn-outline-primary"><input type="radio" name="tangki" value="BKB" id="BKB">BK B</label>
                  <label for="BB" class="btn btn-outline-primary"><input type="radio" name="tangki" value="BB" id="BB">BB</label>
                  <label for="MP" class="btn btn-outline-primary"><input type="radio" name="tangki" value="MP" id="MP">Proses</label>
                  <h6>Variant</h6>
