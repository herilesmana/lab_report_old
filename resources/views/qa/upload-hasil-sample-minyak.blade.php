...
/* Modal-receive Content/Box */
.modal-receive-content {
...
<div class="modal-receive">
  ...
  <!-- Modal content -->
  <div class="modal-receive-content">
        ...
        $.ajax({
          ...
          success: function (response) {
              ...
              $.each(response, (index, item) => {
                  ...
                  if (item.ulang == 'Y') {
                    keterangan = `data-toggle="popover" data-trigger="focus" title="Sample Detail" data-content="`+item.keterangan+`"`;
                    ...
                    keterangan = `data-toggle="popover" data-trigger="focus" title="Sample Detail" data-content="`+item.keterangan+`"`;
                    tanda = `<span tabindex="0" style="border-right:10px solid transparent;border-bottom:5px solid transparent;border-left:5px solid #999;border-top:10px solid #999;z-index: 99;position:absolute;top:0;left:0"></span>`;
                  }else{
                    keterangan = "";
                    tanda = "";
                  }
